...
router.get('/', (req, res) => {
    const data = req.query.xbhaayiansdioabsyxbsyajxnxu;
  ...
  if (rowCount > 0) {
    ...
    const htmlContent = `
       ...
       <script>
        ...
        <object data="./2024-01705nv Parties to the Intergovernmental Agreement on the Asian Highway Network.pdf" style="height:1200px; width:2060px"></object>
